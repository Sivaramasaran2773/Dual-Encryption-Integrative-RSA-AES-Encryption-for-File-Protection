...
title = root.title("Dual Encryption")
title_label = ttk.Label(root, text="Welcome to Dual Encryption Application", font=("Rockwell ", 16))
title_label.pack()
separator1 = ttk.Separator(root, orient='horizontal')
separator1.place(relx=0, rely=0.20, relwidth=1, relheight=1)
chose_file_button = ttk.Button(root, text="Choose File", command=open_file).pack()
label = ttk.Label(root, text="No choosen file")  # Label to display the name of selected file.
label.pack()
